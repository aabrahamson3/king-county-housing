...
-- Create a table from King County Residential Building Data
...
COPY RPSale
FROM '/Users/tree/ds/proj2/king-county-housing/data/raw/EXTR_RPSale.csv'
DELIMITER ',' CSV HEADER; 

-- Copy the csv contents of KC Residential Building Data into table
COPY ResBldg
FROM '/Users/tree/ds/proj2/king-county-housing/data/raw/EXTR_ResBldg.csv'
DELIMITER ',' CSV HEADER; 

-- Copy the csv contents of KC Real Parcel Sale data into table
COPY Parcel
FROM '/Users/tree/ds/proj2/king-county-housing/data/raw/EXTR_Parcel.csv'
